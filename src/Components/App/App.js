...
import PlayListtt from '../PlayListtt/PlayListtt';
      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <PlayListtt playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks} onRemove={this.removeTrack} onNameChange={this.updatePlaylistName} onSave={this.savePlaylist} />
          </div>
        </div>
      </div>
    );
